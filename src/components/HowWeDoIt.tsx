export default function HowWeDoIt() {
   return (
      <section id="how-we-do-it" className="bg-foreground py-24 sm:py-32 relative text-background overflow-hidden">
         ...
         <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
            <div className="mx-auto max-w-2xl lg:text-center">
               ...
               <p className="mt-2 text-3xl font-bold tracking-tight text-background sm:text-4xl text-balance">
                  System Architecture
               </p>
               <p className="mt-6 text-lg leading-8 text-background/80 font-sans">
            ...
            <div className="mx-auto mt-16 max-w-5xl sm:mt-20 lg:mt-24">
               <div className="rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-8 backdrop-blur-sm shadow-2xl relative overflow-hidden">
                  ...
                  <div className="relative z-10 grid grid-cols-1 md:grid-cols-5 gap-4 items-center justify-items-center py-8">
                     ...
                     <div className="flex flex-col items-center text-center space-y-4 w-full group">
                        <div className="h-20 w-20 rounded-full border-2 border-background/20 bg-background/5 flex items-center justify-center group-hover:border-accent group-hover:shadow-[0_0_15px_rgba(0,245,255,0.3)] transition-all duration-300">
                        ...
                        <div>
                           ...
                           <p className="text-xs text-background/60 mt-1">USSD Interface</p>
                        </div>
                     </div>
                     ...
                     {/* Node 2 */}
                     <div className="flex flex-col items-center text-center space-y-4 w-full group">
                        <div className="h-20 w-20 rounded-2xl border-2 border-background/20 bg-background/5 flex items-center justify-center group-hover:border-accent group-hover:shadow-[0_0_15px_rgba(0,245,255,0.3)] transition-all duration-300">
                           <svg className="h-8 w-8 text-background" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div>
                           ...
                           <p className="text-xs text-background/60 mt-1">Telco API & KMS</p>
                        </div>
                     </div>
                     ...
                     {/* Node 3 */}
                     <div className="flex flex-col items-center text-center space-y-4 w-full group">
                        <div className="h-24 w-24 rounded-lg outline outline-2 outline-offset-4 outline-accent/50 bg-gradient-to-br from-accent/20 to-accent/5 flexItems-center justify-center border border-accent relative">
                        ...
                        <div>
                           ...
                           <p className="text-xs text-background/60 mt-1">Proof Generation & On-chain</p>
                        </div>
                     </div>
               ...
               <div className="mt-12 text-center text-sm font-sans text-background/60 max-w-2xl mx-auto">
